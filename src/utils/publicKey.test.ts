...
describe('parseCredentialPublicKey', () => {
  test('default', async () => {
    ...
    expect(publicKey).toMatchInlineSnapshot(
      `"0x1fd0593f9f25ed8ecab174bba6ea6fcf22909c53b3a4e34d5a9f6abd37d6f98cf4954eec64a4b8a39c89e7c4a00b315359e0113fa3fa325ac23cc30ab98a5f21"`,
    )
  })

  test('args: uncompressed', async () => {
    const cPublicKey = hexToBytes(
